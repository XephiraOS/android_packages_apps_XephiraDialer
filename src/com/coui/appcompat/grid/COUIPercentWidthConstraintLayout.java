...
public class COUIPercentWidthConstraintLayout extends ConstraintLayout {
    ...
    private void initAttr(AttributeSet attributeSet) {
        if (getContext() != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, o.f5353l3);
            int i10 = o.f5361m3;
            int i11 = i.f4968g;
            ...
            this.mPaddingType = obtainStyledAttributes.getInteger(o.f5385p3, 0);
            this.mPaddingSize = obtainStyledAttributes.getInteger(o.f5377o3, 0);
            this.mPercentEnabled = obtainStyledAttributes.getBoolean(o.f5393q3, true);
            this.mMode = obtainStyledAttributes.getInt(o.f5401r3, 0);
            this.mIsParentChildHierarchy = obtainStyledAttributes.getBoolean(o.f5369n3, false);
    ...
    public static class LayoutParams extends ConstraintLayout.LayoutParams {
        ...
        private void init(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, o.f5409s3);
            this.mGridNumber = obtainStyledAttributes.getInt(o.f5417t3, 0);
            this.mPercentMode = obtainStyledAttributes.getInt(o.f5425u3, 0);
            obtainStyledAttributes.recycle();
        }
