...
jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r0v0 com.bumptech.glide.load.DecodeFormat, still in use, count: 1, list:
  (r0v0 com.bumptech.glide.load.DecodeFormat) from 0x001a: SPUT (r0v0 com.bumptech.glide.load.DecodeFormat) (LINE:27) com.bumptech.glide.load.DecodeFormat.c com.bumptech.glide.load.DecodeFormat
...
public final class DecodeFormat {
    ...
    public static final DecodeFormat f19388c = new DecodeFormat();
    ...
    public static DecodeFormat[] values() {
        return (DecodeFormat[]) f19389d.clone();
    }
}
