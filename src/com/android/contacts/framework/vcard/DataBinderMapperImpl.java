...
public class DataBinderMapperImpl extends androidx.databinding.e {
    ...
    public static final SparseIntArray f16339a = new SparseIntArray(0);

    /* loaded from: classes.dex */
    public static class a {

        /* renamed from: a, reason: collision with root package name */
        public static final SparseArray<String> f16340a;
    ...
    public static class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final HashMap<String, Integer> f16341a = new HashMap<>(0);
    }
    ...
    public int getLayoutId(String str) {
        Integer num;
        if (str == null || (num = b.f16341a.get(str)) == null) {
            return 0;
        }
        return num.intValue();
    }
    ...
    public ViewDataBinding getDataBinder(androidx.databinding.f fVar, View[] viewArr, int i10) {
        if (viewArr == null || viewArr.length == 0 || f16339a.get(i10) <= 0 || viewArr[0].getTag() != null) {
            return null;
        }
        throw new RuntimeException("view must have a tag");
    }
