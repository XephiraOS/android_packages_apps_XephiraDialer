...
public class DataBinderMapperImpl extends e {
    ...
    public static final SparseIntArray f14146a = new SparseIntArray(0);

    /* loaded from: classes.dex */
    public static class a {

        /* renamed from: a, reason: collision with root package name */
        public static final SparseArray<String> f14147a;
    ...
    public static class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final HashMap<String, Integer> f14148a = new HashMap<>(0);
    }
    ...
    public String convertBrIdToString(int i10) {
        return a.f14147a.get(i10);
    }

    @Override // androidx.databinding.e
    public ViewDataBinding getDataBinder(f fVar, View view, int i10) {
        if (f14146a.get(i10) <= 0 || view.getTag() != null) {
            return null;
        }
    ...
    public int getLayoutId(String str) {
        Integer num;
        if (str == null || (num = b.f14148a.get(str)) == null) {
            return 0;
        }
        return num.intValue();
    }
    ...
    public ViewDataBinding getDataBinder(f fVar, View[] viewArr, int i10) {
        if (viewArr == null || viewArr.length == 0 || f14146a.get(i10) <= 0 || viewArr[0].getTag() != null) {
            return null;
        }
        throw new RuntimeException("view must have a tag");
    }
