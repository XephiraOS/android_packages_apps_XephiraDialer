...
public class BRPluginServiceInfo {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BRPluginServiceInfo) || hashCode() != ((BRPluginServiceInfo) obj).hashCode()) {
            return false;
        }
        return true;
    }
    ...
    public boolean isParent() {
        if (!TextUtils.isEmpty(this.mParentID) && !OplusPhoneUtils.DeviceState.UNLOCK_DEVICE.equals(this.mParentID)) {
            return false;
        }
        return true;
    }
