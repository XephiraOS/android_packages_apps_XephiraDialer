...
public class MasterCompat extends IMaster.Stub {
    ...
    public static final Object f29030f = new Object();

    /* renamed from: g, reason: collision with root package name */
    public static volatile MasterCompat f29031g;

    private MasterCompat() {
    }

    public static MasterCompat N7() {
        if (f29031g == null) {
            synchronized (f29030f) {
                try {
                    if (f29031g == null) {
                        f29031g = new MasterCompat();
                    }
                } finally {
                }
            }
