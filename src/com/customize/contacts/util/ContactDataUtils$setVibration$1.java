...
@InterfaceC1470d(c = "com.customize.contacts.util.ContactDataUtils$setVibration$1", f = "ContactDataUtils.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes3.dex */
public final class ContactDataUtils$setVibration$1 extends SuspendLambda implements v9.p<kotlinx.coroutines.E, kotlin.coroutines.c<? super m9.q>, Object> {
    final /* synthetic */ ContactDataUtils.a $callBack;
    final /* synthetic */ Uri $contactUri;
    final /* synthetic */ Context $context;
    final /* synthetic */ String $vibration;
    int label;

    /* compiled from: ContactDataUtils.kt */
    @InterfaceC1470d(c = "com.customize.contacts.util.ContactDataUtils$setVibration$1$1", f = "ContactDataUtils.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.customize.contacts.util.ContactDataUtils$setVibration$1$1, reason: invalid class name */
    /* loaded from: classes3.dex */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ContactDataUtils$setVibration$1(String str, Context context, Uri uri, ContactDataUtils.a aVar, kotlin.coroutines.c<? super ContactDataUtils$setVibration$1> cVar) {
        super(2, cVar);
        this.$vibration = str;
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final kotlin.coroutines.c<m9.q> create(Object obj, kotlin.coroutines.c<?> cVar) {
        return new ContactDataUtils$setVibration$1(this.$vibration, this.$context, this.$contactUri, this.$callBack, cVar);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            contentValues.put("custom_vibration", this.$vibration);
    ...
    @Override // v9.p
    public final Object invoke(kotlinx.coroutines.E e10, kotlin.coroutines.c<? super m9.q> cVar) {
        return ((ContactDataUtils$setVibration$1) create(e10, cVar)).invokeSuspend(m9.q.f35511a);
    }
}
