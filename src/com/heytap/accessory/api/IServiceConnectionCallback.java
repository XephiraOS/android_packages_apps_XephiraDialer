...
public interface IServiceConnectionCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IServiceConnectionCallback {
        ...
        public static class Proxy implements IServiceConnectionCallback {
            ...
            public IBinder f25204f;

            public Proxy(IBinder iBinder) {
                this.f25204f = iBinder;
            }
            ...
            public void a2(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken("com.heytap.accessory.api.IServiceConnectionCallback");
                    a.d(obtain, bundle, 0);
                    this.f25204f.transact(2, obtain, obtain2, 0);
            ...
            public void r5(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken("com.heytap.accessory.api.IServiceConnectionCallback");
                    a.d(obtain, bundle, 0);
                    this.f25204f.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static IServiceConnectionCallback N7(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.heytap.accessory.api.IServiceConnectionCallback");
            if (queryLocalInterface != null && (queryLocalInterface instanceof IServiceConnectionCallback)) {
                return (IServiceConnectionCallback) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i10, Parcel parcel, Parcel parcel2, int i11) {
            ...
            if (i10 != 1598968902) {
                if (i10 != 1) {
                    ...
                    a2((Bundle) a.c(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                } else {
                    r5((Bundle) a.c(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                }
                return true;
            }
