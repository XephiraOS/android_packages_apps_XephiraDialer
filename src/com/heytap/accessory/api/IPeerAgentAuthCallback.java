...
public interface IPeerAgentAuthCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPeerAgentAuthCallback {
        ...
        public static class Proxy implements IPeerAgentAuthCallback {
            ...
            public IBinder f25197f;

            public Proxy(IBinder iBinder) {
                this.f25197f = iBinder;
            }
            ...
            public void T5(Bundle bundle) {
                ...
                try {
                    ...
                    a.d(obtain, bundle, 0);
                    this.f25197f.transact(1, obtain, obtain2, 0);
        ...
        public static IPeerAgentAuthCallback N7(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            if (queryLocalInterface != null && (queryLocalInterface instanceof IPeerAgentAuthCallback)) {
                return (IPeerAgentAuthCallback) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i10, Parcel parcel, Parcel parcel2, int i11) {
            ...
            if (i10 != 1598968902) {
                ...
                T5((Bundle) a.c(parcel, Bundle.CREATOR));
