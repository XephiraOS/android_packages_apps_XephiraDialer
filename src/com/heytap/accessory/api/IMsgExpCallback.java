...
public interface IMsgExpCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMsgExpCallback {
        ...
        public static class Proxy implements IMsgExpCallback {
            ...
            public IBinder f25192f;

            public Proxy(IBinder iBinder) {
                this.f25192f = iBinder;
            }
            ...
            public void E3(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken("com.heytap.accessory.api.IMsgExpCallback");
                    a.d(obtain, bundle, 0);
                    this.f25192f.transact(1, obtain, obtain2, 0);
            ...
            public void J2(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken("com.heytap.accessory.api.IMsgExpCallback");
                    a.d(obtain, bundle, 0);
                    this.f25192f.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static IMsgExpCallback N7(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.heytap.accessory.api.IMsgExpCallback");
            if (queryLocalInterface != null && (queryLocalInterface instanceof IMsgExpCallback)) {
                return (IMsgExpCallback) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i10, Parcel parcel, Parcel parcel2, int i11) {
            ...
            if (i10 != 1598968902) {
                if (i10 != 1) {
                    ...
                    J2((Bundle) a.c(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                } else {
                    E3((Bundle) a.c(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                }
                return true;
            }
