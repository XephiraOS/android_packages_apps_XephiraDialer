...
public final class MapEntry<K, V> extends AbstractMessage {
    ...
    public static <K, V> MapEntry<K, V> newDefaultInstance(Descriptors.Descriptor descriptor, WireFormat.FieldType fieldType, K k10, WireFormat.FieldType fieldType2, V v10) {
    ...
    public static <V> boolean isInitialized(Metadata metadata, V v10) {
