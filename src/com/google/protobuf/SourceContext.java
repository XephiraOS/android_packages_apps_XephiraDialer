...
public final class SourceContext extends GeneratedMessageV3 implements SourceContextOrBuilder {
    ...
    public boolean equals(Object obj) {
        ...
        if (getFileName().equals(sourceContext.getFileName()) && getUnknownFields().equals(sourceContext.getUnknownFields())) {
            return true;
        }
        return false;
    }
    ...
    public int getSerializedSize() {
        ...
        if (!GeneratedMessageV3.isStringEmpty(this.fileName_)) {
            i10 = GeneratedMessageV3.computeStringSize(1, this.fileName_);
        } else {
            i10 = 0;
        }
