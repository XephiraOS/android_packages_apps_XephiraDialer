...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public ForegroundLinearLayout(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.foregroundBoundsChanged = false;
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, m.f31268U3, i10, 0, new int[0]);
        this.foregroundGravity = obtainStyledAttributes.getInt(m.f31290W3, this.foregroundGravity);
        Drawable drawable = obtainStyledAttributes.getDrawable(m.f31279V3);
        if (drawable != null) {
            setForeground(drawable);
        }
        this.mForegroundInPadding = obtainStyledAttributes.getBoolean(m.f31301X3, true);
