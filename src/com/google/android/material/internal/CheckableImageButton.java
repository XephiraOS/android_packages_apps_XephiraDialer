...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    public CheckableImageButton(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.checkable = true;
        this.pressable = true;
        K.j0(this, new C0446a() { // from class: com.google.android.material.internal.CheckableImageButton.1
            ...
            public void onInitializeAccessibilityNodeInfo(View view, J.d dVar) {
                ...
                dVar.f0(CheckableImageButton.this.isCheckable());
                dVar.g0(CheckableImageButton.this.isChecked());
            }
        });
    }
}
