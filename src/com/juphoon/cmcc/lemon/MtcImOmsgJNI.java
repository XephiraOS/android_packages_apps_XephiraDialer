...
public class MtcImOmsgJNI {
    ...
    public static final native int Mtc_ImOMsgGetMsgCount(int i10);

    public static final native int Mtc_ImOMsgGetMsgIdByIndex(int i10, int i11);

    public static final native int Mtc_ImOMsgGetMsgTypeByIndex(int i10, int i11);

    public static final native int Mtc_ImOMsgGetSessIdByIndex(int i10, int i11);
