...
public class MtcCapJNI {
    ...
    public static final native int Mtc_CapQryLst(int i10, Object obj, boolean z10);

    public static final native int Mtc_CapQryOne(String str, Object obj, int i10, int i11, boolean z10);

    public static final native int Mtc_CapQryOneImd(String str, Object obj, int i10, int i11, boolean z10);

    public static final native int Mtc_CapQryOpt(String str, Object obj, int i10, int i11);
