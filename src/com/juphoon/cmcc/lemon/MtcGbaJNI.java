...
public class MtcGbaJNI {
    ...
    public static final native int Mtc_GbaAuthEnterSecCtx(int i10, String str, String str2, String str3, String str4);

    public static final native String Mtc_GbaAuthGetBtid();

    public static final native String Mtc_GbaAuthGetKsNaf(String str, int i10);

    public static final native int Mtc_GbaAuthSetKsExtNaf(String str);

    public static final native int Mtc_GbaBootStart(int i10, int i11);

    public static final native void Mtc_GbaBootStop(int i10);
