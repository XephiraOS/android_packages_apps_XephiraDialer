...
public class MtcLcsJNI {
    ...
    public static final native int Mtc_LcsActivate(String str, int i10, String str2, String str3, String str4, String str5);

    public static final native int Mtc_LcsActiveEvnt(long j10);

    public static final native int Mtc_LcsEvntLeave(boolean z10);

    public static final native int Mtc_LcsGetSpecifiedKeySize(String str, String str2);

    public static final native String Mtc_LcsGetSpecifiedKeyVal(String str, String str2, int i10);

    public static final native boolean Mtc_LcsHasAudioCodec();
