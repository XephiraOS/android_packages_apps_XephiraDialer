...
public class MtcAcvDbJNI {
    ...
    public static final native String Mtc_AcvDbGetSrvAddr();

    public static final native int Mtc_AcvDbGetSrvPort();

    public static final native String Mtc_AcvDbGetUrl();

    public static final native int Mtc_AcvDbSetSrvAddr(String str);

    public static final native int Mtc_AcvDbSetSrvPort(int i10);

    public static final native int Mtc_AcvDbSetUrl(String str);
