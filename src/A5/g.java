...
public final class g {
    ...
    public final List<int[]> f6416a = new ArrayList();

    /* renamed from: b, reason: collision with root package name */
    public final List<String> f6417b = new ArrayList();

    public final void a(int[] iArr, String str) {
        this.f6416a.add(iArr);
        this.f6417b.add(str);
    }
    ...
    public final synchronized void b() {
        ...
        a(new int[]{385}, "HR");
        a(new int[]{387}, "BA");
        a(new int[]{VibrateUtils.STRENGTH_OFFSET, 440}, "DE");
        ...
        a(new int[]{478}, "UZ");
        a(new int[]{479}, "LK");
        a(new int[]{COUIIndividualStatementDialog.MEDIUM_LARGE_SCREEN_SW_THRESHOLD}, "PH");
        a(new int[]{481}, "BY");
        a(new int[]{482}, "UA");
        a(new int[]{484}, "MD");
        a(new int[]{485}, "AM");
        ...
        a(new int[]{OplusRecorder.NAMR_BYTES_P_SEC, 709}, "NO");
        a(new int[]{729}, "IL");
    ...
    public String c(String str) {
        ...
        for (int i11 = 0; i11 < size && parseInt >= (i10 = (iArr = this.f6416a.get(i11))[0]); i11++) {
            if (iArr.length != 1) {
                i10 = iArr[1];
            }
            if (parseInt <= i10) {
                return this.f6417b.get(i11);
            }
        }
        return null;
    }
