...
public class f extends k {
    public f() {
        ...
        b("area", 0, 2, 0);
        b(com.heytap.accessory.e.f25269e, 1073745920, 36864, 1);
        b("base", 0, 1024, 0);
        ...
        b("caption", 1073745920, OplusPhoneCapabilities.CAPABILITY_INVITE_PARTICIPANTS, 0);
        b("center", 1073745924, 4, 0);
        b("cite", 1073745920, 36864, 1);
        b("code", 1073745920, 36864, 1);
        b("col", 0, 2097216, 0);
        b("colgroup", 64, OplusPhoneCapabilities.CAPABILITY_INVITE_PARTICIPANTS, 0);
        ...
        b("noframes", 4116, BaseJobAgent.ERROR_AGENT_REQUEST_IN_PROGRESS, 0);
        ...
        b("tbody", 4194304, OplusPhoneCapabilities.CAPABILITY_INVITE_PARTICIPANTS, 0);
        b("td", 1073745924, 32, 0);
        b("textarea", 1073741824, 4096, 0);
        b("tfoot", 4194592, OplusPhoneCapabilities.CAPABILITY_INVITE_PARTICIPANTS, 0);
        b("th", 1073745924, 32, 0);
        b("thead", 4194592, OplusPhoneCapabilities.CAPABILITY_INVITE_PARTICIPANTS, 0);
        b("title", 1073741824, 1024, 0);
        b("tr", ModuleType.TYPE_CLOCK, 6291456, 0);
        ...
        h("applet", "body");
        h("area", "map");
        h(com.heytap.accessory.e.f25269e, "body");
        h("base", "head");
        h("basefont", "body");
        h("bdo", "body");
        h("bgsound", "head");
        ...
        a("button", OplusAutoRedialNotificationUI.TYPE, "CDATA", "submit");
        a("caption", "align", "NMTOKEN", null);
        a("col", "align", "NMTOKEN", null);
        a("col", "span", "CDATA", OplusPhoneUtils.DeviceState.LOCK_DEVICE);
        a("col", "valign", "NMTOKEN", null);
        a("colgroup", "align", "NMTOKEN", null);
        a("colgroup", "span", "CDATA", OplusPhoneUtils.DeviceState.LOCK_DEVICE);
        ...
        a("form", Constants.MessagerConstants.METHOD_KEY, "CDATA", "get");
        a("frame", "frameborder", "CDATA", OplusPhoneUtils.DeviceState.LOCK_DEVICE);
        ...
        a("iframe", "frameborder", "CDATA", OplusPhoneUtils.DeviceState.LOCK_DEVICE);
        ...
        a("input", OplusAutoRedialNotificationUI.TYPE, "CDATA", "text");
        ...
        a("rt", "rbspan", "CDATA", OplusPhoneUtils.DeviceState.LOCK_DEVICE);
        ...
        a("td", "colspan", "CDATA", OplusPhoneUtils.DeviceState.LOCK_DEVICE);
        a("td", "headers", "IDREFS", null);
        a("td", "nowrap", "BOOLEAN", null);
        a("td", "rowspan", "CDATA", OplusPhoneUtils.DeviceState.LOCK_DEVICE);
        ...
        a("th", "colspan", "CDATA", OplusPhoneUtils.DeviceState.LOCK_DEVICE);
        a("th", "headers", "IDREFS", null);
        a("th", "nowrap", "BOOLEAN", null);
        a("th", "rowspan", "CDATA", OplusPhoneUtils.DeviceState.LOCK_DEVICE);
        ...
        a("ul", OplusAutoRedialNotificationUI.TYPE, "NMTOKEN", null);
        ...
        a(com.heytap.accessory.e.f25269e, "class", "NMTOKEN", null);
        ...
        a(com.heytap.accessory.e.f25269e, "dir", "NMTOKEN", null);
        ...
        a("applet", "id", "ID", null);
        a("area", "id", "ID", null);
        a(com.heytap.accessory.e.f25269e, "id", "ID", null);
        a("base", "id", "ID", null);
        ...
        a(com.heytap.accessory.e.f25269e, "lang", "NMTOKEN", null);
        ...
        c("Aacute", 193);
        c("aacute", 225);
        c("Abreve", Imgcodecs.IMWRITE_TIFF_YDPI);
        c("abreve", Imgcodecs.IMWRITE_TIFF_COMPRESSION);
        c("ac", 8766);
        c("acd", 8767);
        c("Acirc", 194);
        c("acirc", 226);
        ...
        c("alpha", 945);
        c("Amacr", 256);
        c("amacr", Imgcodecs.IMWRITE_TIFF_XDPI);
        c("amalg", 10815);
        c("AMP", 38);
        c("amp", 38);
        c("And", 10835);
        ...
        c("ccupssm", 10832);
        c("Cdot", 266);
        c("cdot", OplusAnimationUtils.DURATION_FADE_ANIM);
        c("cedil", 184);
        c("Cedilla", 184);
        c("cemptyv", 10674);
        c("cent", 162);
        ...
        c("emsp13", 8196);
        c("emsp14", 8197);
        c("ENG", UIUtil.CONSTANT_INT_THTEE_HUNDRED_THIRTY);
        c("eng", 331);
        c("ensp", 8194);
        c("Eogon", 280);
        c("eogon", 281);
        ...
        c("iinfin", 10716);
        c("iiota", 8489);
        c("IJlig", COUIHapticFeedbackConstants.EDGE_SHORT_VIBRATE);
        c("ijlig", COUIHapticFeedbackConstants.EDGE_LIST_VIBRATE);
        c("Im", 8465);
        c("Imacr", 298);
        c("imacr", 299);
        c("image", 8465);
        ...
        c("imagline", 8464);
        c("imagpart", 8465);
        c("imath", COUIHapticFeedbackConstants.STEPPING_SHORT_VIBRATE);
        c("imof", 8887);
        c("imped", 437);
        c("Implies", 8658);
        c("in", 8712);
        ...
        c("infin", 8734);
        c("infintie", 10717);
        c("inodot", COUIHapticFeedbackConstants.STEPPING_SHORT_VIBRATE);
        c("Int", 8748);
        c("int", 8747);
        c("intcal", 8890);
        c("integers", 8484);
        ...
        c("IOcy", BaseJobAgent.ERROR_CONNECTION_INVALID_PARAM);
        c("iocy", 1105);
        c("Iogon", COUIHapticFeedbackConstants.GRANULAR_SHORT_VIBRATE);
        c("iogon", COUIHapticFeedbackConstants.SHORT_VIBRATE);
        c("Iopf", 120128);
        c("iopf", 120154);
        c("Iota", 921);
        c("iota", 953);
        ...
        c("Iuml", 207);
        c("iuml", 239);
        c("Jcirc", COUIHapticFeedbackConstants.GRANULAR_SHORT_VIBRATE_SYNC);
        c("jcirc", 309);
        c("Jcy", 1049);
        c("jcy", 1081);
        c("Jfr", 120077);
        ...
        c("lltri", 9722);
        c("Lmidot", 319);
        c("lmidot", ModuleType.TYPE_WEATHER);
        c("lmoust", 9136);
        c("lmoustache", 9136);
        c("lnap", 10889);
        c("lnapprox", 10889);
        ...
        c("ocy", 1086);
        c("odash", 8861);
        c("Odblac", ModuleType.TYPE_ACCOUNT);
        c("odblac", 337);
        c("odiv", 10808);
        c("odot", 8857);
        c("odsold", 10684);
        ...
        c("sc", 8827);
        c("scap", 10936);
        c("Scaron", ModuleType.TYPE_LAUNCHER);
        c("scaron", 353);
        c("sccue", 8829);
        c("scE", 10932);
        c("sce", 10928);
        ...
        c("urcrop", 8974);
        c("Uring", 366);
        c("uring", COUIBackgroundAnimationUtil.DISAPPEAR_DURATION);
        c("urtri", 9721);
        c("Uscr", 119984);
        c("uscr", 120010);
        c("utdot", 8944);
