    ...
    */
    public static byte[] e(java.io.InputStream r8, int r9, int r10) {
        ...
        L86:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: Z.c.e(java.io.InputStream, int, int):byte[]");
    }
    ...
    public static long g(InputStream inputStream, int i10) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            j10 += (d10[i11] & FastPairConstants.GO_INTENT_NOT_SET) << (i11 * 8);
        }
        return j10;
    }
    ...
    public static void o(OutputStream outputStream, long j10, int i10) {
        byte[] bArr = new byte[i10];
        for (int i11 = 0; i11 < i10; i11++) {
