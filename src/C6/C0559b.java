...
public class C0559b extends AbstractC0564g<Integer> {
    public C0559b(List<C1337c<Integer>> list) {
        super(list);
    }
    ...
    public int q(C1337c<Integer> c1337c, float f10) {
        ...
        if (c1337c.f35155b != null && c1337c.f35156c != null) {
            ...
            return l6.c.c(l6.g.b(f10, 0.0f, 1.0f), c1337c.f35155b.intValue(), c1337c.f35156c.intValue());
        }
