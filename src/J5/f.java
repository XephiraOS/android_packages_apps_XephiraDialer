...
public final class f {
    ...
    public static final int[] f33881e = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* renamed from: f, reason: collision with root package name */
    public static final f[] f33882f = b();
    ...
    public static final class b {
        ...
        /* renamed from: b, reason: collision with root package name */
        public final a[] f33890b;

        public b(int i10, a... aVarArr) {
            this.f33889a = i10;
            this.f33890b = aVarArr;
        }
    ...
    public S4.b a() {
        int e10 = e();
        S4.b bVar = new S4.b(e10);
        bVar.m(0, 0, 9, 9);
        int i10 = e10 - 8;
        bVar.m(i10, 0, 8, 9);
        bVar.m(0, i10, 9, 8);
        int length = this.f33884b.length;
        for (int i11 = 0; i11 < length; i11++) {
            int i12 = this.f33884b[i11] - 2;
            for (int i13 = 0; i13 < length; i13++) {
                if ((i11 != 0 || (i13 != 0 && i13 != length - 1)) && (i11 != length - 1 || i13 != 0)) {
                    bVar.m(this.f33884b[i13] - 2, i12, 5, 5);
                }
            }
        }
        int i14 = e10 - 17;
    ...
    public int e() {
        return (this.f33883a * 4) + 17;
    }

    public b f(ErrorCorrectionLevel errorCorrectionLevel) {
        return this.f33885c[errorCorrectionLevel.ordinal()];
    }
    ...
    public String toString() {
        return String.valueOf(this.f33883a);
    }
}
