...
/* compiled from: OplusIncallFloatingNaviLandscapeViewBindingImpl.java */
/* loaded from: classes.dex */
public class D extends C {

    /* renamed from: b0, reason: collision with root package name */
    public static final ViewDataBinding.i f2476b0 = null;

    /* renamed from: c0, reason: collision with root package name */
    public static final SparseIntArray f2477c0;

    /* renamed from: Z, reason: collision with root package name */
    public final RelativeLayout f2478Z;
    ...
    public D(androidx.databinding.f fVar, View view) {
        this(fVar, view, ViewDataBinding.R0(fVar, view, 17, f2476b0, f2477c0));
    }
    ...
    */
    public void A0() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: O1.D.A0():void");
    }

    public void G1(FloatingWindowCommandViewModel floatingWindowCommandViewModel) {
        this.f2475Y = floatingWindowCommandViewModel;
        synchronized (this) {
            this.f2479a0 |= 8388608;
        }
    ...
    public void H1(FloatingWindowViewModel floatingWindowViewModel) {
        this.f2474X = floatingWindowViewModel;
        synchronized (this) {
            this.f2479a0 |= 33554432;
        }
    ...
    public boolean d1(int i10, Object obj) {
        if (BR.commandViewModel == i10) {
            ...
            i1((NaviLandscapeFloatingWindowViewModel) obj);
    ...
    @Override // O1.C
    public void i1(NaviLandscapeFloatingWindowViewModel naviLandscapeFloatingWindowViewModel) {
        this.f2473W = naviLandscapeFloatingWindowViewModel;
        synchronized (this) {
            this.f2479a0 |= 16777216;
        }
        r0(BR.viewModel);
        super.W0();
    }
    ...
    public D(androidx.databinding.f fVar, View view, Object[] objArr) {
        super(fVar, view, 23, (TextSwitcher) objArr[2], (TextSwitcher) objArr[4], (AutoWrapTextView) objArr[5], (TextView) objArr[6], (ImageView) objArr[11], (ImageView) objArr[12], (ImageSwitcher) objArr[1], (ImageView) objArr[3], (LinearLayout) objArr[13], (TextView) objArr[9], (TextView) objArr[8], (ImageView) objArr[15], (ImageSwitcher) objArr[10], (ImageView) objArr[16], (LinearLayout) objArr[14], (TextView) objArr[7]);
        this.f2479a0 = -1L;
        this.f2457G.setTag(null);
        this.f2458H.setTag(null);
        this.f2459I.setTag(null);
        this.f2460J.setTag(null);
        this.f2463M.setTag(null);
        RelativeLayout relativeLayout = (RelativeLayout) objArr[0];
        this.f2478Z = relativeLayout;
        relativeLayout.setTag(null);
        this.f2464N.setTag(null);
        this.f2466P.setTag(null);
        this.f2467Q.setTag(null);
        this.f2469S.setTag(null);
        this.f2472V.setTag(null);
        c1(view);
        O0();
    }
}
