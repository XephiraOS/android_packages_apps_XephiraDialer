...
public final class q {
    ...
    public static String a(String str) {
        ...
        if (str.length() >= 2) {
            ...
            for (Object[] objArr : f30050b) {
                if (objArr[0].equals(substring)) {
                    Object obj = objArr[1];
                    if (obj == f30049a) {
                        return c(2, ((Integer) objArr[2]).intValue(), str);
                    }
            ...
            if (str.length() >= 3) {
                ...
                for (Object[] objArr2 : f30051c) {
                    if (objArr2[0].equals(substring2)) {
                        Object obj2 = objArr2[1];
                        if (obj2 == f30049a) {
                            return c(3, ((Integer) objArr2[2]).intValue(), str);
                        }
                        return b(3, ((Integer) obj2).intValue(), str);
                    }
                }
                for (Object[] objArr3 : f30052d) {
                    if (objArr3[0].equals(substring2)) {
                        Object obj3 = objArr3[1];
                        if (obj3 == f30049a) {
                            return c(4, ((Integer) objArr3[2]).intValue(), str);
                        }
                ...
                if (str.length() >= 4) {
                    ...
                    for (Object[] objArr4 : f30053e) {
                        if (objArr4[0].equals(substring3)) {
                            Object obj4 = objArr4[1];
                            if (obj4 == f30049a) {
                                return c(4, ((Integer) objArr4[2]).intValue(), str);
                            }
