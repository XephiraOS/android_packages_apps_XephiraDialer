...
public final class c {
    ...
    public final View f4129a;

    /* renamed from: b, reason: collision with root package name */
    public final ArgbEvaluator f4130b;
    ...
    public c(View itemView) {
        ...
        this.f4129a = itemView;
        this.f4130b = new ArgbEvaluator();
    }
    ...
    public static final void h(ValueAnimator valueAnimator, COUICardListSelectedItemLayout cOUICardListSelectedItemLayout, int i10, int i11, c this$0, ValueAnimator it) {
        ...
        if (animatedFraction <= 0.0f) {
            ...
            Object evaluate = this$0.f4130b.evaluate(animatedFraction, Integer.valueOf(i10), Integer.valueOf(i11));
    ...
    public final ValueAnimator f(final COUICardListSelectedItemLayout cOUICardListSelectedItemLayout) {
        ...
        ofFloat.setInterpolator(new TimeInterpolator() { // from class: W0.a
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: W0.b
    ...
    public final void i() {
        this.f4129a.postDelayed(new b(), 600L);
    }
}
