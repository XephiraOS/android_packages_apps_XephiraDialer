...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder) {
        this(context, menuBuilder, null, false, C0961a.f30091I, 0);
    }
    ...
    private MenuPopup createPopup() {
        ...
        if (Math.min(point.x, point.y) >= this.mContext.getResources().getDimensionPixelSize(d.f30139c)) {
    ...
    private void showPopup(int i10, int i11, boolean z10, boolean z11) {
        ...
        if (z10) {
            if ((C0455j.b(this.mDropDownGravity, this.mAnchorView.getLayoutDirection()) & 7) == 5) {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view) {
        this(context, menuBuilder, view, false, C0961a.f30091I, 0);
    }
