...
public class k {
    ...
    private static final p.i<String, Constructor<? extends View>> sConstructorMap = new p.i<>();
    ...
    public static class a implements View.OnClickListener {
        ...
        public final void a(Context context) {
            ...
            while (context != null) {
                try {
                    if (!context.isRestricted() && (method = context.getClass().getMethod(this.f7386b, View.class)) != null) {
                        this.f7387c = method;
                        this.f7388d = context;
                        return;
                    }
            ...
            int id = this.f7385a.getId();
            if (id == -1) {
                str = "";
            } else {
                str = " with id '" + this.f7385a.getContext().getResources().getResourceEntryName(id) + "'";
            }
            throw new IllegalStateException("Could not find method " + this.f7386b + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + this.f7385a.getClass() + str);
        }

        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            if (this.f7387c == null) {
                a(this.f7385a.getContext());
            }
            try {
                this.f7387c.invoke(this.f7388d, view);
    ...
    private View createViewByPrefix(Context context, String str, String str2) {
        String str3;
        p.i<String, Constructor<? extends View>> iVar = sConstructorMap;
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z10, boolean z11) {
        int i10;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, e.j.f30376S3, 0, 0);
        if (z10) {
            i10 = obtainStyledAttributes.getResourceId(e.j.f30381T3, 0);
        } else {
            i10 = 0;
        }
        if (z11 && i10 == 0 && (i10 = obtainStyledAttributes.getResourceId(e.j.f30386U3, 0)) != 0) {
            Log.i(LOG_TAG, "app:theme is now deprecated. Please move to using android:theme instead.");
        }
        obtainStyledAttributes.recycle();
        if (i10 != 0) {
            if (!(context instanceof C1147d) || ((C1147d) context).c() != i10) {
                return new C1147d(context, i10);
            }
            return context;
        }
        return context;
