...
public abstract class x implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ViewParent parent = x.this.mSrc.getParent();
            if (parent != null) {
    ...
    private boolean onTouchForwarded(MotionEvent motionEvent) {
        ...
        toLocalMotionEvent(vVar, obtainNoHistory);
        boolean e10 = vVar.e(obtainNoHistory, this.mActivePointerId);
    ...
    */
    private boolean onTouchObserved(android.view.MotionEvent r6) {
        ...
        L6d:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.x.onTouchObserved(android.view.MotionEvent):boolean");
    }
