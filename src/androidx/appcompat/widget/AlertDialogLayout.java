...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    public static int a(View view) {
        int x10 = androidx.core.view.K.x(view);
        if (x10 > 0) {
            return x10;
        }
    ...
    public final boolean b(int i10, int i11) {
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == e.f.f30213U) {
                    view = childAt;
                } else if (id == e.f.f30225l) {
                    view2 = childAt;
                } else {
                    if ((id != e.f.f30227n && id != e.f.f30229p) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
    ...
    public final void forceUniformWidth(int i10, int i11) {
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L7e:
            ...
            int r2 = androidx.core.view.C0455j.b(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L98
            r3 = 5
    ...
    public final void setChildFrame(View view, int i10, int i11, int i12, int i13) {
