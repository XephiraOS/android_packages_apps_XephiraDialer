...
public class LinearLayoutCompat extends ViewGroup {
    ...
    */
    public void layoutVertical(int r18, int r19, int r20, int r21) {
        ...
        L76:
            ...
            int r1 = androidx.core.view.C0455j.b(r1, r2)
            r1 = r1 & 7
            if (r1 == r14) goto L90
            r2 = 5
            if (r1 == r2) goto L8a
    ...
    */
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i10) {
        ...
        int[] iArr = e.j.f30467k1;
        K w10 = K.w(context, attributeSet, iArr, i10, 0);
        androidx.core.view.K.h0(this, context, iArr, attributeSet, w10.r(), i10, 0);
        int k10 = w10.k(e.j.f30477m1, -1);
        if (k10 >= 0) {
            setOrientation(k10);
        }
        int k11 = w10.k(e.j.f30472l1, -1);
        if (k11 >= 0) {
            setGravity(k11);
        }
        boolean a10 = w10.a(e.j.f30482n1, true);
        if (!a10) {
            setBaselineAligned(a10);
        }
        this.mWeightSum = w10.i(e.j.f30492p1, -1.0f);
        this.mBaselineAlignedChildIndex = w10.k(e.j.f30487o1, -1);
        this.mUseLargestChild = w10.a(e.j.f30507s1, false);
        setDividerDrawable(w10.g(e.j.f30497q1));
        this.mShowDividers = w10.k(e.j.f30512t1, 0);
        this.mDividerPadding = w10.f(e.j.f30502r1, 0);
        w10.y();
    }
