...
public class SwitchCompat extends CompoundButton {
    ...
    public static class b extends e.f {
        ...
        public final Reference<SwitchCompat> f7812a;

        public b(SwitchCompat switchCompat) {
            this.f7812a = new WeakReference(switchCompat);
        }

        @Override // androidx.emoji2.text.e.f
        public void a(Throwable th) {
            SwitchCompat switchCompat = this.f7812a.get();
        ...
        if (drawable != null) {
            if (this.mHasThumbTint || this.mHasThumbTintMode) {
                ...
                if (this.mHasThumbTint) {
                    C.a.o(mutate, this.mThumbTintList);
                }
                if (this.mHasThumbTintMode) {
                    C.a.p(this.mThumbDrawable, this.mThumbTintMode);
                }
        ...
        if (drawable != null) {
            if (this.mHasTrackTint || this.mHasTrackTintMode) {
                ...
                if (this.mHasTrackTint) {
                    C.a.o(mutate, this.mTrackTintList);
                }
                if (this.mHasTrackTintMode) {
                    C.a.p(this.mTrackDrawable, this.mTrackTintMode);
                }
    ...
    private void setOffStateDescriptionOnRAndAbove() {
        ...
        if (charSequence == null) {
            charSequence = getResources().getString(e.h.f30264d);
        }
        androidx.core.view.K.D0(this, charSequence);
    }

    private void setOnStateDescriptionOnRAndAbove() {
        CharSequence charSequence = this.mTextOn;
        if (charSequence == null) {
            charSequence = getResources().getString(e.h.f30265e);
        }
        androidx.core.view.K.D0(this, charSequence);
    }
    ...
    private void stopDrag(MotionEvent motionEvent) {
        ...
        if (z10) {
            ...
            if (Math.abs(xVelocity) > this.mMinFlingVelocity) {
                if (!S.b(this) ? xVelocity <= 0.0f : xVelocity >= 0.0f) {
                    z11 = false;
                }
            } else {
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable3 != null) {
            ...
            if (background != null) {
                C.a.l(background, i24, i13, i25, i15);
            }
        }
        super.draw(canvas);
    }
    ...
    public void drawableHotspotChanged(float f10, float f11) {
        ...
        Drawable drawable = this.mThumbDrawable;
        if (drawable != null) {
            C.a.k(drawable, f10, f11);
        }
        Drawable drawable2 = this.mTrackDrawable;
        if (drawable2 != null) {
            C.a.k(drawable2, f10, f11);
        }
    }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            Rect c10 = u.c(this.mThumbDrawable);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (drawable3 != null) {
            ...
            i17 = Math.max(i17, c10.left);
            i18 = Math.max(i18, c10.right);
        }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r7) {
        ...
        L38:
            ...
            r2 = r0
        L3b:
            boolean r0 = androidx.appcompat.widget.S.b(r6)
            if (r0 == 0) goto L42
            float r2 = -r2
        L42:
    ...
    public void setSwitchTextAppearance(Context context, int i10) {
        ...
        ColorStateList c10 = u10.c(e.j.f30449g3);
        if (c10 != null) {
            this.mTextColors = c10;
        } else {
            this.mTextColors = getTextColors();
        }
        int f10 = u10.f(e.j.f30434d3, 0);
        if (f10 != 0) {
            float f11 = f10;
        ...
        setSwitchTypefaceByIndex(u10.k(e.j.f30439e3, -1), u10.k(e.j.f30444f3, -1));
        if (u10.a(e.j.f30474l3, false)) {
            this.mSwitchTransformationMethod = new C1088a(getContext());
        } else {
    ...
    public void setThumbResource(int i10) {
        setThumbDrawable(C0991a.b(getContext(), i10));
    }
    ...
    public void setTrackResource(int i10) {
        setTrackDrawable(C0991a.b(getContext(), i10));
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0961a.f30098P);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i10) {
        ...
        int[] iArr = e.j.f30350N2;
        K w10 = K.w(context, attributeSet, iArr, i10, 0);
        androidx.core.view.K.h0(this, context, iArr, attributeSet, w10.r(), i10, 0);
        Drawable g10 = w10.g(e.j.f30365Q2);
        this.mThumbDrawable = g10;
        if (g10 != null) {
            g10.setCallback(this);
        }
        Drawable g11 = w10.g(e.j.f30410Z2);
        this.mTrackDrawable = g11;
        if (g11 != null) {
            g11.setCallback(this);
        }
        setTextOnInternal(w10.p(e.j.f30355O2));
        setTextOffInternal(w10.p(e.j.f30360P2));
        this.mShowText = w10.a(e.j.f30370R2, true);
        this.mThumbTextPadding = w10.f(e.j.f30395W2, 0);
        this.mSwitchMinWidth = w10.f(e.j.f30380T2, 0);
        this.mSwitchPadding = w10.f(e.j.f30385U2, 0);
        this.mSplitTrack = w10.a(e.j.f30375S2, false);
        ColorStateList c10 = w10.c(e.j.f30400X2);
        if (c10 != null) {
            this.mThumbTintList = c10;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode d10 = u.d(w10.k(e.j.f30405Y2, -1), null);
        if (this.mThumbTintMode != d10) {
            this.mThumbTintMode = d10;
            this.mHasThumbTintMode = true;
        }
        if (this.mHasThumbTint || this.mHasThumbTintMode) {
            applyThumbTint();
        }
        ColorStateList c11 = w10.c(e.j.f30416a3);
        if (c11 != null) {
            this.mTrackTintList = c11;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode d11 = u.d(w10.k(e.j.f30422b3, -1), null);
        if (this.mTrackTintMode != d11) {
            this.mTrackTintMode = d11;
            this.mHasTrackTintMode = true;
        }
        if (this.mHasTrackTint || this.mHasTrackTintMode) {
            applyTrackTint();
        }
        int n10 = w10.n(e.j.f30390V2, 0);
        if (n10 != 0) {
