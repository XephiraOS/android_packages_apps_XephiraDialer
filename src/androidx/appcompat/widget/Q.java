...
public class Q extends B {
    ...
    public static boolean f7791c = false;

    /* renamed from: b, reason: collision with root package name */
    public final WeakReference<Context> f7792b;

    public Q(Context context, Resources resources) {
        super(resources);
        this.f7792b = new WeakReference<>(context);
    }
    ...
    public Drawable getDrawable(int i10) {
        Context context = this.f7792b.get();
        if (context != null) {
            return A.g().s(context, this, i10);
        }
        return a(i10);
    }
