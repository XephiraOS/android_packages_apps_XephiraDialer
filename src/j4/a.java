...
public class a<T> {
    ...
    public a() {
        ...
        this.rawType = (Class<? super T>) C$Gson$Types.k(typeTokenTypeArgument);
    ...
    public final boolean equals(Object obj) {
        if ((obj instanceof a) && C$Gson$Types.f(this.type, ((a) obj).type)) {
            return true;
        }
        return false;
    }
    ...
    private a(Type type) {
        ...
        this.type = b10;
        this.rawType = (Class<? super T>) C$Gson$Types.k(b10);
